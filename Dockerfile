...
RUN unzip target/camunda-rest-0.1.0.jar -d target/extracted
...
ENTRYPOINT ["java", "-Djava.security.egd=file:/dev/./urandom", "-cp","app:app/lib/*","ch.helsana.bpm.CamundaRestApplication"]
